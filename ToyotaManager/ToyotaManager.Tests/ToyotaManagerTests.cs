...
namespace ToyotaManager.Tests
{
    ...
    public class ToyotaManagerTests
    {
        ...
        public void SortedComplectationOfCarsTest()
        {
            ...
            //assert    
            CollectionAssert.AreEqual(testedCosts, Program.SortedComplectationOfCars(cars));
        }
        ...
        public void SortedCarCostTest()
        {
            ...
            //assert
            CollectionAssert.AreEqual(testedCarCosts, Program.SortedCarCost(cars));
        }
        ...
        public void GetComplectationOfPriceRangeTest()
        {
            ...
            //assert
            CollectionAssert.AreEqual(testedCarInPriceRange, Program.GetComplectationOfPriceRange(cars, a, b));
        }
    }
}
